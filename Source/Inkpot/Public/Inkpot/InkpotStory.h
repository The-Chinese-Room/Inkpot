...
public:
	 ...
	 *
	 * @return The current line of text for the story.
	 */
	 ...
	 *
	 * @return The collated lines of text up to the point of termination.
	 */
	UFUNCTION(BlueprintCallable, Category="Inkpot|Story")
	 ...
	 *
	 * @return The current line of text, wrapped as a UInkpotLine.
	 */
	UFUNCTION(BlueprintPure, Category="Inkpot|Story")
	 ...
	 *
	 * @return true is the story has choices to display, false otherwise.
	 */
	UFUNCTION(BlueprintPure, Category="Inkpot|Story")
	bool HasChoices();
	 ...
	 * @return true if the switch was succesful.
	 */
	UFUNCTION(BlueprintCallable, Category="Inkpot|Story")
	 ...
	 *
	 * @return The flowname of the active flow.
	 */
	UFUNCTION(BlueprintPure, Category="Inkpot|Story")
	 ...
	 * @return True if the flow still has content.
	 */
	UFUNCTION(BlueprintPure, Category="Inkpot|Story")
	 ...
	 * @param Success, returns if the operation was a succes. False typically means the variable does not exist.
	 */
	UFUNCTION(BlueprintCallable, Category="Inkpot|Story")
	 ...
	 *
	 * @param Variable, name of the variable to clear.
	 * @return return true if the variable exists, false otherwise.
	 */
	UFUNCTION(BlueprintPure, Category="Inkpot|Story")
	 ...
	 *
	 * @return List of all named knots.
	 */
	UFUNCTION(BlueprintPure, Category = "Inkpot|Story")
	 ...
	 *
	 * @return List of all named stitches within knot.
	 */
	UFUNCTION(BlueprintPure, Category = "Inkpot|Story")
	 ...
	 *
	 * @return String, the serialised state of the Ink VM 
	 */
	UFUNCTION(BlueprintCallable, Category="Inkpot|Story")
	FString ToJSON();
